...
enhanceWithAI() {
  ...
  this.http.post('http://192.168.65.136:30085/Review/enhance', payload).subscribe({
    next: (res: any) => {
  ...
  openConversation(event: Event) {
    ...
    const chatApiUrl = `http://192.168.65.136:30085/chat/conversation/create?user1=${this.currentViewerId}&user2=${this.clientId}`;
