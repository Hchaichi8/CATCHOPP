...
import { AiCvService, CVAnalysisRequest, CVAnalysisResponse } from '../../services/ai-cv.service';
...
export class AiCvGeneratorComponent implements OnInit, OnDestroy {
  ...
  onFileSelected(event: any): void {
    ...
    if (this.aiCvService.isImageFile(file)) {
      // Handle image upload - we'll process it during analysis
      this.cvText = '[IMAGE_UPLOADED]'; // Placeholder to indicate image is ready
    } else {
      // Handle text file
